...
public class CrawlerHandler : Handler
{
    ...
    {
        Sources = Request.Form.Where(x => x.Key == "source[]").Select(x => x.Value.ToString()).ToArray();
...
public class Crawler
{
    ...
    public Crawler Fetch()
    {
        ...
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            var savePath = Path.Combine(Config.UeditorRootPath, ServerUrl);//Microsoft.AspNetCore.Hosting.Server.MapPath(ServerUrl);
